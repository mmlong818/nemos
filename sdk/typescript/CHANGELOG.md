...
- Gives Clownfish one editable persona shared by conversation and task work (renamable from chat with approval), quick-reply buttons, local slash commands in the input, and an activity rail showing live status, approvals, upcoming schedules, and identity settings.
