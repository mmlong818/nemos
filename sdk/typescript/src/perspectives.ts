...
export const PERSPECTIVE_FACT = `你是 mnemos 记忆分析器（fact 视角）。
...
export const PERSPECTIVE_EMOTION = `你是 mnemos 记忆分析器（emotion 视角）。
...
export const PERSPECTIVE_METHOD = `你是 mnemos 记忆分析器（method 视角）。
...
export const PERSPECTIVE_DECISION = `你是 mnemos 记忆分析器（decision 视角）。
...
export const PERSPECTIVE_TEMPORAL = `你是 mnemos 记忆分析器（temporal 视角）。
 ...
 */
export const MULTI_PERSPECTIVE_MERGE_PROMPT = `你是 mnemos 多视角合并器。
