...
(() => {
  ...
  fixture.job={id:'ui-detail-fixture',title:'整理一份活动复盘简报',status:'succeeded',updatedAt:'2026-09-07T10:00:00Z',payload:{teamPlan:{objective:'整理一份活动复盘简报',model:'synthetic-model',materials:'[S1]【合成测试资料】报名 48 人，到场 36 人；反馈表回收 28 份。',requiredFields:['关键结论','下一步'],workers:[{name:'资料整理助理',revision:1}]}},checkpoints:[{data:{teamReceipt:{stageId:'worker:1',botName:'资料整理助理',state:'returned',receivedAt:'2026-09-07T09:59:00Z',returnedAt:'2026-09-07T10:00:00Z',output:'【合成回执】到场率为 75%，反馈覆盖到场者约 77.8%。',inputHash:'synthetic-hash'}}}],stepReceipts:[{version:1,receiptId:'synthetic-failed',stepId:'worker:1',attempt:1,state:'failed',result:{completedAt:'2026-09-07T09:58:00Z',summary:'第一次未完成',rawOutput:'【合成失败原始成果】',claims:[],evidenceRefs:[],unresolvedItems:['模型输出缺失'],inputHash:'a'.repeat(64)}},{version:1,receiptId:'synthetic-success',stepId:'worker:1',attempt:2,state:'succeeded',result:{completedAt:'2026-09-07T10:00:00Z',summary:'到场率 75%',rawOutput:'【合成成功原始成果】到场 36 人。',claims:[{key:'attendance-rate',value:'75%',sourceRefs:['material:S1'],evidenceState:'source-linked'}],evidenceRefs:[{ref:'material:S1'}],unresolvedItems:['满意度未知'],inputHash:'b'.repeat(64),outputHash:'c'.repeat(64)}}],result:{data:{delivery:{summary:'已将活动数据整理为两项结论，并列出下一次活动前需要确认的事项。',fields:[{label:'关键结论',value:'到场 36 人，占报名人数的 75%。反馈表回收 28 份，不能用未回收的反馈推断满意度。',sources:['S1：用户提供的活动记录（合成）']},{label:'下一步',value:'1. 补充缺席原因，区分报名与到场差异。\n2. 核对反馈题目与原始答案，再形成满意度结论。',sources:['S1：活动记录；以上建议需人工确认']}]},structuredMerge:{status:'unresolved',orderedResults:[{stepId:'worker:1'}],unresolvedItems:['满意度未知']}}}};
