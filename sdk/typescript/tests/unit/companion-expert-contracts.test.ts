...
test("covers document, presentation, data, coordination, automation, security, contract, and visual work", () => {
  const cases: Array<[string, string, string]> = [
    ...
    ["workflow-builder", "检查权限、密钥泄露和自动化安全", "security_compliance"],
