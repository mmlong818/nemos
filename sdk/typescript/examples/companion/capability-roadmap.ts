...
const PHASES: RoadmapPhase[] = [
  ...
  },
  {
    id: "runtime-closure",
    title: "统一执行闭环",
    goal: "把能力目录、主要入口和扩展的声明变成可验证的真实执行能力。",
    items: [
      { id: "all-runtime-tools", title: "核心工具统一登记", outcome: "记忆、任务、技能、委派、产物和通用工具出现在同一能力目录。", status: "done" },
      { id: "surface-routing", title: "入口工具路由", outcome: "任务、学习、能力、文件和工作按同一场景规则收窄工具。", status: "done" },
