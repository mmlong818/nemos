...
export type ElementType = 'text' | 'shape' | 'picture' | 'group' | 'table' | 'chart' | 'passthrough';
...
export type SlideElement = TextElement | PictureElement | GroupElement | TableElement | ChartElement | PassthroughElement;
