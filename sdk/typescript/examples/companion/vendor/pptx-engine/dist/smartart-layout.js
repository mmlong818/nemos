...
exports.SMARTART_PALETTE = void 0;
exports.layoutShapes = layoutShapes;
/** PowerPoint default theme accent series (colors picked in order) */
exports.SMARTART_PALETTE = [
    '4472C4',
    'ED7D31',
    'A5A5A5',
    'FFC000',
...
function layoutShapes(layout, items, cx, cy) {
    ...
    const color = (i) => exports.SMARTART_PALETTE[i % exports.SMARTART_PALETTE.length];
    const out = [];
    if (layout === 'list') {
