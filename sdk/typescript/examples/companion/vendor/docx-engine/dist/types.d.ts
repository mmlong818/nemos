...
export declare const TOTAL_PAGES_MARK = "\uE000";
...
export declare const PAGE_MARK = "\uE001";
 ...
 */
export type ImageWrap = 'square-left' | 'square-right' | 'tight-left' | 'tight-right' | 'through-left' | 'through-right' | 'topBottom' | 'behind' | 'front';
