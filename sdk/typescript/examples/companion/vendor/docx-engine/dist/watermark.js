...
exports.WATERMARK_NS = void 0;
exports.readWatermarkText = readWatermarkText;
exports.watermarkParagraphXml = watermarkParagraphXml;
...
function watermarkParagraphXml(text) {
    const shape = '<v:shape id="PowerPlusWaterMarkObject1" o:spid="_x0000_s2049" type="#_x0000_t136"' +
        ...
        '<v:fill opacity=".5"/>' +
        `<v:textpath style="font-family:&quot;DengXian&quot;;font-size:1pt" string="${(0, xml_utils_1.escapeXmlAttr)(text)}"/>` +
        '</v:shape>';
    const shapetype = '<v:shapetype id="_x0000_t136" coordsize="21600,21600" o:spt="136" adj="10800"' +
