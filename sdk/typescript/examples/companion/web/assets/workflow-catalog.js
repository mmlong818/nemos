...
(() => {
  ...
  { id: "research", backendId: "research-brief", name: "深度研究与核验", icon: "search", summary: "检索外部来源、核验关键声明并形成可追溯结论", description: "围绕一个问题规划研究路径，检索可访问来源并分级，对关键声明做独立复核；清楚标出证据、时点和限制。", use: "行业研究、竞品、专题调研", deliverable: "带来源台账的研究报告", format: "html", featured: true, detail: "规划、检索、来源分级、事实核验和结论复审" },
