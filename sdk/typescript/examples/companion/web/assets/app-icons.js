...
(() => {
  ...
  const PATHS = Object.freeze({
    ...
    "message-circle": '<path d="M12 3.75C6.9 3.75 2.75 7.25 2.75 11.55c0 2.5 1.2 4.7 3.1 6.15L5 21.25l3.6-1.95c1.05.3 2.2.45 3.4.45 5.1 0 9.25-3.5 9.25-8.2S17.1 3.75 12 3.75Z"/>',
    ...
    skills: '<path d="M4.5 4.5A1.5 1.5 0 0 1 6 3h14v18H6a1.5 1.5 0 0 1-1.5-1.5v-15Z"/><path d="M20 17H6.5"/><path fill="currentColor" stroke="none" d="M10.5 3h4v7.5l-2-1.7-2 1.7V3Z"/>',
    plug: '<path d="M8.5 2.5v5M15.5 2.5v5"/><path d="M4.5 7.5h15v3a7.5 7.5 0 0 1-15 0v-3Z"/><path d="M12 18v3.5"/>',
