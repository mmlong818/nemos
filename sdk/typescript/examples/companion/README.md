...
2026-09-06 新增“团队”入口 `/bots`：可创建/编辑专职 Bot，提交文字资料，查看真实交接回执与自动汇总。已保存的成功步骤可在失败或中断后复用。当前不为新 Bot 开放工具和私人记忆；已生成独立便携预览版，未覆盖旧客户端。详见[便携版验收记录](../../../../docs/bot-market-release-2026-09-06.md)。

“团队 → Bot 市场”（`/bots?view=market`）提供三个精选原生适配模板：项目推进助理、会前准备助理、植物养护记录助理。查看完整规则与能力边界后添加到“我的 Bot”；可修改名称、规则和启用状态，重复添加不覆盖个人版本。添加不调用模型，任务才调用已配置的模型。市场为随应用发布的本地精选目录，不自动下载第三方脚本或同步 Grok 账号。详见[市场适配与验证](../../../../docs/bot-market-adoption-2026-09-06.md)。
...
能力页提供多项内置能力，覆盖研究、核验、办公文档、OCR、会议纪要、内容润色、演示、产品设计、市场简报、工作流、商务和能力生成。
