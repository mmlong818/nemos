...
背景：原方案是接 [Easel 连接器](easel-studio-program-design-2026-09-08.md)。你决定不验证 Easel，
...
这与[已定的决定](easel-studio-program-design-2026-09-08.md)一致——不引入抓取平台实时热搜的
...
3. 这一步不用自己实现——本轮已有的[交付物待确认判断](deliverable-alignment-program-design-2026-09-08.md)
