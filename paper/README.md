...
- 2026-08-10 已重新核对 `results/manifest.json` 中 5 个结果文件的 SHA-256，并从冻结 JSON 重新计算论文中的 BUC、ASP 和 FOR 百分比；文件哈希和正文数字一致。
- 2026-08-10 已把中英文 PDF 共 13 页逐页渲染检查，未发现裁切、重叠、空白页、缺字或表格溢出。
