...
[![版本](https://img.shields.io/badge/版本-v0.5.5-b33f72)](https://github.com/mmlong818/nemos/tree/v0.5.5)
...
当前版本已将任务、Bot、能力、文件、记忆和模型设置整理为统一的个人 AI 助理工作台。支持任务级 Bot 自动分派、受控文字协作、模型排队与取消、结果回执、附件共享，以及本机优先的数据保存。
...
- **Bot**是可复用的工作角色和工作规则，例如植物养护记录、会前准备或项目推进；
- **能力**是可执行的完整流程，例如文档转换、研究、演示生成或文件分析；
- **工具**是一次具体操作，例如读取文件、调用模型或运行连接器。

Bot 市场只包含随应用发布的本地精选模板，不同步 Grok 账号、不下载第三方脚本，也不携带外部 Bot 的私人记忆。
