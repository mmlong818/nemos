...
> 一款本机优先、带长期记忆的 AI 工作应用。用户像使用熟悉的对话工具一样新建对话，再按需要切换为完成任务或学习辅导；系统会自动调用能力、处理文件并持续保留上下文。
...
| 入口 | 用户操作 | 当前实现 |
|---|---|---|
| **对话** | 直接新建、搜索、切换或删除独立对话，需要时切换为完成任务或学习辅导，并可上传图片、文件或发送语音 | 内容自动命名、多任务并行、独立上下文、结果回到原对话 |
