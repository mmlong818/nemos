...
![小丑鱼任务工作台](docs/assets/readme/clownfish-task-final-20260907.png)

工作台的核心路径是：助理接收目标 → 自动分派到合适的 Bot/能力 → 进入任务队列 → 返回可追溯的结果。页面保持同一套工作区结构，状态切换不会改变用户所在的主上下文。

![小丑鱼助理首页](docs/assets/readme/clownfish-assistant-final-20260907.png)
...
![小丑鱼记忆工作区](docs/assets/readme/clownfish-memory-final-20260907.png)
